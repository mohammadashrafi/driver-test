...
export const validation = {
  PRICE: {
    required: 'قی الزامیست',
    min: { value: 1, message: 'فی باید بیشتر از صفر باشد' },
  },
  AMOUNT: {
    required: 'مقدار الزامیست',
    min: { value: 1, message: 'مقدار باید بیشتر از صفر باشد' },
  },
  REMAINING: {
    required: 'مقدار باقی مانده الزامیست',
    min: { value: 0, message: 'مقدار باقی مانده نمی‌تواند منفی باشد' },
  },
  REGISTER_PASSWORD: {
